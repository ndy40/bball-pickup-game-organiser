...
export default function EventDetail({ event }: { event: Event }) {
  ...
  return (
    <div className="relative flex flex-1 flex-col ">
      <div className="sticky top-0 z-10 mb-2 flex items-center justify-between bg-white pb-3">
        <div>
        ...
        >
          <button type="button" className="text-green px-4 py-2 text-gray-600">
            <div className="icon">
      ...
      {canJoinEvent ? (
        !isAttending ? (
          <button
            ...
            className="mb-4text-lg hove:text-opacity-90 mb-4 w-full rounded-full
            bg-emerald-600 px-4 py-4 text-lg font-bold text-white shadow-md hover:bg-emerald-700 hover:bg-opacity-90 hover:shadow-md "
          >
            Join Event
          </button>
        ) : (
