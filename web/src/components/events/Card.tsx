  ...
  return (
    <Item>
      <Container>
        <DateContainer>
          <DateContent>
            <span className="text-gray-400">{moment(event.session_date).format("DD/MM/YY")}</span>
        ...
        <EventDetails>
          <div className="flex flex-col">
            ...
            <div className="flex w-full space-x-2 mt-2">
              <button className="w-6/12 p-1 bg-gray-400 hover:bg-gray-600 text-white">View</button>
              <button className="w-6/12 p-1 bg-blue-400 hover:bg-blue-500 text-white">Join</button>
            </div>
          </div>
        </EventDetails>
      </Container>
