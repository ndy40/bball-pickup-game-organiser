        ...
        <EventDetails>
          <div className="flex flex-col">
            ...
            <div className="details container flex flex-col gap-x-6 text-gray-500 space-y-1">
              ...
              <p>Players: <span className="text-gray-100 rounded-full py-0.5 px-2 bg-gray-500">{event.max_players}</span></p>
              <p>Attending: <span className="text-gray-100 rounded-full py-0.5 px-2 bg-gray-500">{event.players.length}</span></p>
            </div>
